...
@app.route('/career')
def career():
    career = get_static_json("static/files/career.json")
    return render_template('career.html', common=common, career=career)

@app.route('/skills')
def skills():
    skills = get_static_json("static/files/skills.json")
    return render_template('skills.html', common=common, skills=skills)


@app.route('/certification')
def certification():
    data = get_static_json("static/files/certification.json")
    return render_template('certification.html', common=common, data=data)
